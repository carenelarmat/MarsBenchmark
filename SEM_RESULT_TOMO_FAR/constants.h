...
!=== case KELUD
!  logical, parameter :: PLOT_CROSS_SECTIONS = .false.
!  real(kind=CUSTOM_REAL),parameter :: CROSS_SECTION_X = 371041.0_CUSTOM_REAL
!  real(kind=CUSTOM_REAL),parameter :: CROSS_SECTION_Y = 999999.0_CUSTOM_REAL
!  real(kind=CUSTOM_REAL),parameter :: CROSS_SECTION_Z = 200000.0_CUSTOM_REAL
!=== case Samoa
  logical, parameter :: PLOT_CROSS_SECTIONS = .false.
  real(kind=CUSTOM_REAL),parameter :: CROSS_SECTION_X = 394863.0_CUSTOM_REAL
  real(kind=CUSTOM_REAL),parameter :: CROSS_SECTION_Y = 8326020.0_CUSTOM_REAL
  real(kind=CUSTOM_REAL),parameter :: CROSS_SECTION_Z = 0.0_CUSTOM_REAL
...
! in case MODELING_ATMO = .true. and not USE_SOURCE_RECEIVERS_Z (used for localisation source/receivers)
!! MARS HRSC DEM Golombek 2017 

! integer, parameter :: NX_TOPO_FILE = 1184, NY_TOPO_FILE = 1483
! double precision, parameter :: ORIG_LAT_TOPO =  5.5d0
! double precision, parameter :: ORIG_LONG_TOPO = 134.5d0
! double precision, parameter :: DEGREES_PER_CELL_TOPO_X = 0.00169061707523d0,DEGREES_PER_CELL_TOPO_Y = -0.00168690958165d0
! character(len=*), parameter :: TOPO_FILE = 'DATA/meshfem3D_files/dtm_ins_el0315_mr.da5_SEM.dat'

!! MARS MOLA CASE 463m

! integer, parameter :: NX_TOPO_FILE = 3840, NY_TOPO_FILE = 1920
! double precision, parameter :: ORIG_LAT_TOPO =  10.d0
! double precision, parameter :: ORIG_LONG_TOPO = 130.d0
! double precision, parameter :: DEGREES_PER_CELL_TOPO_X = 0.00390625d0,DEGREES_PER_CELL_TOPO_Y = -0.0078125d0
! character(len=*), parameter :: TOPO_FILE = 'DATA/meshfem3D_files/Mars_MGS_MOLA_DEM_463_Insight.dat'

!! ATMO CASE FLAT TOPO
 integer, parameter :: NX_TOPO_FILE = 2, NY_TOPO_FILE = 2
 double precision, parameter :: ORIG_LAT_TOPO =  -1000000.d0
 double precision, parameter :: ORIG_LONG_TOPO = -1000000.d0
 double precision, parameter :: DEGREES_PER_CELL_TOPO_X = 2000000.d0,DEGREES_PER_CELL_TOPO_Y = 2000000.d0
 character(len=*), parameter :: TOPO_FILE = 'DATA/Mars_topo_flat.dat'
